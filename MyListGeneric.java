...
public class MyListGeneric {
    public static void main(String[] args) {
        ...
        System.out.println("\nCustom class list:");
        GenericMyList<Person> personList = new GenericMyList<>();
        personList.add(new Person("Ankith", 21));
        personList.add(new Person("Hitesh", 21));
        personList.display(); 
        personList.deleteByValue(new Person("Ankith", 21));
        personList.display();
    }
}
